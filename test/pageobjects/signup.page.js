    ...
    const passwordRequirementsLong = '//*[@id="password_requirements"]/div[2]'
    const passwordRequirementsWithNumbers = '//*[@id="password_requirements"]/div[3]'
    const passwordRequirementsWithSymbols = '//*[@id="password_requirements"]/div[4]'
    const passwordRequirementsWithUpperCase = '//*[@id="password_requirements"]/div[5]'
    const inputPromo = '[id="promo_code"]'
